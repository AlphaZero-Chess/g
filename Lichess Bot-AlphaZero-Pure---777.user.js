// ==UserScript==
// @name         Lichess Bot - PURE ALPHAZERO v4.4.0 LEVEL 8 DESTROYER - ENHANCED DEFENSE
// @description  AUTHENTIC AlphaZero Echo - Optimized to BEAT Lichess AI Level 8 - Maximum Defensive Accuracy
// @author       Enhanced Human AI
// @version      4.4.0-ALPHAZERO-LEVEL8-DESTROYER
// @match         *://lichess.org/*
...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * PURE ALPHAZERO BOT v4.4.0 - LEVEL 8 DESTROYER - ENHANCED DEFENSE
 * ═══════════════════════════════════════════════════════════════════════════
 * 
 * CHANGELOG v4.4.0 (LEVEL 8 OPTIMIZATIONS - AUTHENTIC ALPHAZERO + ENHANCED ACCURACY):
 * 🎯 MAJOR: Defensive threshold LOWERED to -50cp (from -100cp) - Earlier defensive activation!
 * 🎯 MAJOR: Defensive creativity BALANCED at 18% - Maintains AlphaZero character with accuracy!
 * 🎯 MAJOR: Defensive risk BALANCED at 35% - Allows positional play while staying solid!
 * 🎯 MAJOR: Defensive depth bonus INCREASED to +5 (from +2) - Deeper calculation = better moves!
 * 🎯 MAJOR: Passed pawn detection sensitivity INCREASED - Detects pawns on rank 4+ (from rank 3)!
 * 🎯 MAJOR: Multiple passed pawn detection - Extra depth +6 when 2+ dangerous pawns detected!
 * 🎯 MAJOR: Passed pawn depth bonus DOUBLED to +4 (from +2) - Critical passed pawn defense!
 * 🎯 MAJOR: Elegant defensive alternatives - Maintains positional sacrifices even when behind!
 * 🎯 ENHANCED: Base depths increased across the board (24/30/32) for stronger play!
 * 🎯 ENHANCED: Endgame depth increased to 32 (from 28) for superior technique!
 * 🎯 ENHANCED: Long-term defensive focus (88%) - Positional compensation over immediate tactics!
 * 🎯 ENHANCED: Passed pawn severity scoring - More aggressive blockading of advanced pawns!
 * 🎯 FIXED: Better handling of multiple simultaneous passed pawns (like the losing game)!
 * 
 * PROBLEM ANALYZED: Bot lost to Level 8 - allowed multiple passed pawns to advance unchecked
 * SOLUTION: Enhanced detection + deeper calculation + MAINTAINED AlphaZero positional character
 * PHILOSOPHY: Beat Level 8 through DEEPER CALCULATION, not by removing creativity!
 * RESULT: Authentic AlphaZero character with Level 8-beating accuracy through superior depth!
 * TARGET: Beat Lichess AI Level 8 while maintaining elegant, positional, creative play!
 * 
 * CHANGELOG v4.3.0 (ADAPTIVE DEFENSIVE SETTINGS - BALANCED PLAY):
 * 🛡️ MAJOR: Defensive Mode when behind - Reduces risk, plays solidly (eval < -100cp)
 * 🛡️ MAJOR: Passed Pawn Danger Detection - Prioritizes stopping advanced enemy pawns
 * 🛡️ MAJOR: Adaptive Risk Tolerance - 78% when ahead, 40% when behind
 * 🛡️ MAJOR: Adaptive Creativity - 35% when equal, 15% when behind for accuracy
 * 🛡️ ENHANCED: Depth boost +2 when behind for defensive accuracy
 * 🛡️ ENHANCED: Depth boost +2 when dangerous passed pawns detected
 * 🛡️ FIXED: Bot now stops advanced enemy passed pawns before promotion
 * 🛡️ FIXED: Better defensive technique in losing positions
 * 
 * PROBLEM SOLVED: Bot lost to Level 8 by allowing d-pawn promotion (d5→d3→d2→d1=Q)
 * SOLUTION: Adaptive defensive mode + passed pawn detection + solid play when behind
 * RESULT: Maintains aggressive AlphaZero style when ahead, plays solidly when defending!
 * 
 * CHANGELOG v4.2.1 (CRITICAL BUG FIX - MOVE REJECTION HANDLING):
 * 🛡️ CRITICAL FIX: Bot now detects and recovers from rejected/illegal moves
 * 🛡️ CRITICAL FIX: Added 3-second move confirmation timeout
 * 🛡️ CRITICAL FIX: WebSocket error message handling for move rejections
 * 🛡️ CRITICAL FIX: Automatic recalculation when move is not confirmed
 * 🛡️ ENHANCED: Improved stuck detection to clear all timers including move confirmation
 * 
 * PROBLEM SOLVED: Bot stopped completely after sending illegal move (no error handling)
 * SOLUTION: Multi-layer move rejection detection + automatic recovery + recalculation
 * 
 * CHANGELOG v4.2.0 (AUTHENTIC ALPHAZERO ECHO - MAXIMUM EXPLOSIVE CREATIVITY):
 * 🔥🔥 CRITICAL: STRONGLY ECHOES ORIGINAL ALPHAZERO - Based on detailed gameplay analysis
 * 🔥🔥 MAJOR: Maximum Creativity - 35% base (was 28%), up to 70% in complex (was 58%)!
 * 🔥🔥 MAJOR: Ultra-Aggressive Winning Mode - Triggers at +100cp (was +150cp)
 * 🔥🔥 MAJOR: Enhanced Positional Sacrifices - 45% willing (was 30%) - TRUE AlphaZero style!
 * 🔥🔥 MAJOR: Maximum Contempt 95 (was 75) - Absolutely NO DRAWS vs weak opponents!
 * 🔥🔥 MAJOR: Winning Creativity 55% (was 40%) - Maximum aggression when ahead
 * 🔥🔥 MAJOR: Risk Tolerance 78% (was 68%) - Takes bold risks for positional gains
 * 🔥🔥 ENHANCED: Initiative Bonus 55 (was 48) - Extremely high initiative value
 * 🔥🔥 ENHANCED: Piece Activity 52 (was 45) - Activity over material
 * 🔥🔥 ENHANCED: Long-term Focus 95% (was 92%) - Deepest strategic vision
 * 🔥🔥 ENHANCED: Acceleration Bonus 35% (was 25%) - Faster advantage conversion
 * 🔥🔥 ENHANCED: Sacrifice Threshold 45% (was 35%) - More willing to sacrifice
 * 🔥🔥 ENHANCED: Aggressive Planning 92% (was 85%) - Maximum aggression
 * 
 * PROBLEM SOLVED: Bot drew vs weak opponents (131 moves), lacked AlphaZero's explosive style
 * SOLUTION: Maximum creativity, ultra-aggressive conversion, stronger contempt, more sacrifices
 * RESULT: Bot now STRONGLY ECHOES original AlphaZero's decisive, creative, aggressive play!
 * 
 ...
 * 
 * VALIDATION LAYERS (v4.4.0 BALANCED):
 ...
 * 7. Winning Conversion: Aggressive acceleration when eval >+100cp
 * 8. BALANCED Defensive Mode: Positional play when behind (eval < -50cp, creativity 18%, risk 35%)
 * 9. ENHANCED Passed Pawn Detection: Advanced detection (rank 4+), depth +4 per pawn, +6 for multiple
 * 10. Elegant Defensive Alternatives: Maintains AlphaZero character with long-term compensation
 * 
 * Optimized for: ALL time controls, SPECIFICALLY TUNED to BEAT Lichess AI Level 8
 * Target: Destroy Lichess Level 8 with enhanced defensive accuracy and passed pawn awareness
 * 
 * Playing Style [AUTHENTIC ALPHAZERO + LEVEL 8 ACCURACY]:
 * - SOLID opening play - no hanging pieces/pawns! (depth 24)
 * - MAXIMUM explosive creativity when ahead/equal (35% base, up to 70% in complex)
 * - POSITIONAL defensive play when behind (18% creativity, 35% risk - maintains character!)
 * - Deep calculation (depth 24-32 adaptive, +5 when behind, +4-6 for passed pawns)
 * - AGGRESSIVE positional sacrifices for activity when winning (45% willing)
 * - ULTRA-SHARP conversion when ahead (triggers at +100cp, 55% creativity)
 * - ELEGANT defensive alternatives when behind (positional compensation, long-term focus 88%)
 * - Deepest long-term planning and strategic vision (95% focus when ahead, 88% when behind)
 * - ADAPTIVE risk tolerance (78% when ahead, 35% when behind - balanced for creativity)
 * - Enhanced passed pawn detection (rank 4+) with severity scoring
 * - Special handling for multiple passed pawns (+6 depth)
 * - Maintains elegant, non-obvious moves even in defensive mode
 * 
 * Core Principles (Authentic AlphaZero + Level 8 Accuracy):
 * ✓ NO BLUNDERS in Opening
 * ✓ EXPLOSIVE Creativity in Balanced/Complex Positions
 * ✓ AGGRESSIVE Conversion when Winning
 * ✓ POSITIONAL Defense when Behind (creativity maintained, accuracy through depth!)
 * ✓ ELEGANT Defensive Alternatives (long-term compensation over immediate tactics)
 * ✓ ENHANCED PASSED PAWN Detection (rank 4+) and Aggressive Stopping
 * ✓ MULTIPLE PASSED PAWN Handling (critical depth boost)
 * ✓ MAINTAINS AlphaZero character: Positional sacrifices, elegant moves, creativity
 * ✓ POSITIONAL Sacrifices for Long-term Gains (when ahead)
 * ✓ SHARP Finishes (80-100 moves, not 150+)
 * ✓ Deep Calculation + Intuitive Elegance
 * ✓ Material Safety + Creative Genius
 * ✓ Adaptive Risk (78% ahead, 40% behind)
 * ═══════════════════════════════════════════════════════════════════════════
 */
...
const CONFIG = {
    ...
    baseDepth: 24,              // Base search depth (stronger foundation) - INCREASED for Level 8
    strategicDepth: 30,         // Depth for strategic positions (deeper calculation) - INCREASED
    endgameDepth: 32,           // INCREASED: Endgame depth for sharper conversion and defense
    openingDepth: 24,           // INCREASED: Solid opening depth to avoid blunders
    classicalDepth: 32,         // INCREASED: Extra depth for classical time controls
    winningDepth: 28,           // NEW: Depth when winning to find fastest mate/conversion - INCREASED
    ...
    // Strategic preferences - MAXIMUM EXPLOSIVE CREATIVITY (AlphaZero signature)
    sacrificeThreshold: 0.45,   // INCREASED: Much more willing to sacrifice for position/activity (was 0.35)
    unconventionalRate: 0.35,   // INCREASED: 35% base unconventional - maximum creativity (was 0.28)
    complexPositionBonus: 0.35, // INCREASED: 35% extra in complex positions (max 70% total creativity!) (was 0.30)
    longTermFocus: 0.95,        // INCREASED: 95% focus on long-term play - deepest vision (was 0.92)
    eleganceThreshold: 0.35,    // INCREASED: Favor elegant moves more often
    
    // NEW: Winning conversion parameters (ULTRA-SHARP finishes)
    winningThreshold: 100,      // LOWERED: Eval > +100cp = winning position - trigger earlier! (was 150)
    winningCreativity: 0.55,    // INCREASED: 55% creativity when winning - maximum aggression! (was 0.40)
    accelerationBonus: 0.35,    // INCREASED: Bigger bonus for moves that increase advantage (was 0.25)
    positionalSacrifice: 0.45,  // INCREASED: Much more willing to sacrifice when winning (was 0.30)
    
    // AlphaZero personality - MAXIMUM EXPLOSIVE & AGGRESSIVE
    contempt: 95,               // INCREASED: Maximum contempt to avoid draws - play for wins! (was 75)
    riskTolerance: 0.78,        // INCREASED: Very high risk tolerance for positional gains (was 0.68)
    aggressivePlanning: 0.92,   // INCREASED: Maximum aggressive long-term planning weight (was 0.85)
    
    // NEW: Defensive mode settings (when behind) - BALANCED for Level 8 + AlphaZero Character
    defensiveThresholdMild: -50,     // Eval < -50cp = mild defensive mode - TRIGGER EARLIER!
    defensiveThresholdSerious: -150, // Eval < -150cp = serious defensive mode - EARLIER
    defensiveRiskTolerance: 0.35,    // Reduced risk when behind - BALANCED positional play (was 0.40)
    defensiveCreativity: 0.18,       // Reduced creativity when behind - MAINTAINS AlphaZero character (was 0.15)
    defensiveDepthBonus: 5,          // Extra depth when behind for accuracy - INCREASED from 2
    defensiveLongTermFocus: 0.88,    // Strong emphasis on long-term compensation when behind
    
    // NEW: Passed pawn danger detection - ENHANCED SENSITIVITY
    passedPawnDangerRank: 4,         // Advanced pawns on rank 4+ are dangerous - MORE SENSITIVE
    passedPawnDepthBonus: 4,         // Extra depth to deal with passed pawns - INCREASED from 2
    multiplePassedPawnBonus: 6,      // Extra depth when multiple passed pawns - NEW!
...
/**
 * Detect dangerous advanced passed pawns (ENHANCED for Level 8)
 * Returns object with danger level and count of dangerous pawns
 */
function detectPassedPawnDanger(fen) {
    try {
        // Safety check for valid FEN
        if (!fen || typeof fen !== 'string') {
            return { hasDanger: false, count: 0, severity: 0 };
        }
        ...
        for (let file = 0; file < 8; file++) {
            ...
            // White to move: Check for dangerous Black passed pawns
            if (activeColor === 'w' && blackPawns.length > 0 && whitePawns.length === 0) {
                const advancedBlackPawn = Math.min(...blackPawns);
                // ENHANCED: Detect pawns on rank 1-4 (more sensitive)
                if (advancedBlackPawn <= 3) { // On rank 1-4 (dangerous)
                    dangerousPassedPawns++;
                    const severity = (4 - advancedBlackPawn) * 2; // rank 1=6, rank 2=4, rank 3=2, rank 4=0
                    maxSeverity = Math.max(maxSeverity, severity);
                    debugLog("[DANGER]", `🚨 Dangerous Black passed pawn detected on file ${String.fromCharCode(97 + file)} rank ${advancedBlackPawn + 1} (severity: ${severity})`);
                }
            }
            
            // Black to move: Check for dangerous White passed pawns
            if (activeColor === 'b' && whitePawns.length > 0 && blackPawns.length === 0) {
                const advancedWhitePawn = Math.max(...whitePawns);
                // ENHANCED: Detect pawns on rank 5-8 (more sensitive)
                if (advancedWhitePawn >= 4) { // On rank 5-8 (dangerous)
                    dangerousPassedPawns++;
                    const severity = (advancedWhitePawn - 3) * 2; // rank 8=10, rank 7=8, rank 6=6, rank 5=4
                    maxSeverity = Math.max(maxSeverity, severity);
                    debugLog("[DANGER]", `🚨 Dangerous White passed pawn detected on file ${String.fromCharCode(97 + file)} rank ${advancedWhitePawn + 1} (severity: ${severity})`);
                }
            }
        }
        
        if (dangerousPassedPawns > 0) {
            debugLog("[DANGER]", `⚠️ Total dangerous passed pawns: ${dangerousPassedPawns}, max severity: ${maxSeverity}`);
        }
        
        return {
            hasDanger: dangerousPassedPawns > 0,
            count: dangerousPassedPawns,
...
function getStrategicDepth(phase, isStrategic, timeLeft) {
    ...
    // ENHANCED: Multiple passed pawns get even more depth
    if (currentFen && typeof currentFen === 'string') {
        const pawnDanger = detectPassedPawnDanger(currentFen);
        if (pawnDanger.hasDanger) {
            let depthBonus = CONFIG.passedPawnDepthBonus;
            
            // Multiple passed pawns are extremely dangerous - add extra depth
            if (pawnDanger.count >= 2) {
                depthBonus = CONFIG.multiplePassedPawnBonus;
                debugLog("[ENGINE]", `🚨🚨 MULTIPLE passed pawn danger (${pawnDanger.count}) - CRITICAL depth boost`);
            }
            
            depth = Math.min(depth + depthBonus, CONFIG.classicalDepth);
            debugLog("[ENGINE]", `🚨 Passed pawn danger (count: ${pawnDanger.count}, severity: ${pawnDanger.severity}) - depth: ${depth}`);
        }
    }
...
function applyAlphaZeroLogic(bestMove, alternatives) {
    ...
    // ═══════════════════════════════════════════════════════════
    // NEW v4.4.0: DEFENSIVE MODE - AlphaZero Character + Level 8 Accuracy
    // ═══════════════════════════════════════════════════════════
    const isBehind = topScore < CONFIG.defensiveThresholdMild;
    const isLosingBadly = topScore < CONFIG.defensiveThresholdSerious;
    
    if (isBehind) {
        debugLog("[ENGINE]", `🛡️ DEFENSIVE MODE (${topScore}cp) - AlphaZero positional defense`);
        
        // CRITICAL: Losing badly = play best move for accuracy, but consider positional alternatives
        if (isLosingBadly) {
            debugLog("[ENGINE]", `🛡️🛡️ SERIOUS DEFENSIVE MODE (${topScore}cp) - Prioritizing accuracy`);
            
            // Still allow elegant positional alternatives if very close in evaluation
            if (scoreDiff < 8 && Math.random() < 0.10) { // 10% chance for elegant defense
                const coordination = evaluatePieceCoordination(currentFen);
                const activity = evaluatePieceActivity(currentFen);
                
                if ((coordination > 0.65 || activity > 0.65) && validateMoveForPosition(alternatives[1].move, currentFen)) {
                    debugLog("[ENGINE]", `💎 Elegant defensive resource (Δ${scoreDiff})`);
                    return alternatives[1].move;
                }
            }
            
            debugLog("[ENGINE]", "🛡️ Accurate defensive move");
            return bestMove;
        }
        
        // Mild defensive mode: maintain AlphaZero character with accuracy emphasis
        if (scoreDiff > 18) { // Allow creativity if moves are close
            debugLog("[ENGINE]", "🛡️ Clear best defense - but open to positional alternatives");
            
            // Even with clear best move, consider elegant positional defenses
            if (scoreDiff < 25 && Math.random() < CONFIG.defensiveCreativity * 0.5) {
                const coordination = evaluatePieceCoordination(currentFen);
                if (coordination > 0.70 && validateMoveForPosition(alternatives[1].move, currentFen)) {
                    debugLog("[ENGINE]", `🎯 Positional defensive compensation (Δ${scoreDiff})`);
                    return alternatives[1].move;
                }
            }
        ...
        // AlphaZero-style defensive creativity (18% creativity maintained)
        if (Math.random() > CONFIG.defensiveCreativity) {
            debugLog("[ENGINE]", "🛡️ Defensive accuracy - playing best move");
            return bestMove;
        }
        
        // Consider elegant defensive alternatives (AlphaZero character)
        if (scoreDiff < 15 && validateMoveForPosition(alternatives[1].move, currentFen)) {
            const coordination = evaluatePieceCoordination(currentFen);
            const activity = evaluatePieceActivity(currentFen);
            const mobility = evaluateMobility(currentFen);
            
            // Favor positional compensation over immediate tactics
            if (coordination < 0.60 || activity < 0.60 || mobility < 0.55) {
                if (Math.random() < CONFIG.defensiveLongTermFocus) {
                    debugLog("[ENGINE]", `💫 Positional defensive improvement (Δ${scoreDiff})`);
                    return alternatives[1].move;
                }
            }
            
            // Elegant, non-obvious defensive moves
        ...
        debugLog("[ENGINE]", "🛡️ Solid defensive move");
        return bestMove;
    }
    ...
    // ENHANCED: Stronger response to multiple passed pawns
    let pawnDanger = { hasDanger: false, count: 0, severity: 0 };
    if (currentFen && typeof currentFen === 'string') {
        pawnDanger = detectPassedPawnDanger(currentFen);
    }
    
    if (pawnDanger.hasDanger) {
        // Multiple passed pawns = ALWAYS play best move
        if (pawnDanger.count >= 2 && scoreDiff > 10) {
            debugLog("[ENGINE]", `🚨🚨 CRITICAL: ${pawnDanger.count} passed pawns - playing best defensive move`);
            return bestMove;
        }
        // Single passed pawn = play carefully
        if (scoreDiff > 20) {
...
function initializeChessEngine() {
    ...
    chessEngine.postMessage("setoption name MultiPV value 8");         // INCREASED to 8 for Level 8 - see even more alternatives
    chessEngine.postMessage("setoption name Hash value 768");          // INCREASED to 768 for stronger calculation
    chessEngine.postMessage("setoption name Contempt value 95");       // INCREASED: 95 for maximum aggressive play! (was 75)
    ...
    console.log("🤖 Pure AlphaZero v4.4.0 - AUTHENTIC CHARACTER + LEVEL 8 ACCURACY");
    console.log("🎯 TARGET: Beat Lichess AI Level 8 while maintaining authentic AlphaZero style!");
    console.log("✅ AUTHENTIC DEFENSE: Maintains creativity (18%) and positional play (35% risk) when behind");
    console.log("✅ ACCURACY THROUGH DEPTH: Base depth 24, endgame 32, +5 when behind (not creativity removal!)");
    console.log("✅ ELEGANT ALTERNATIVES: Positional compensation and long-term focus even in defense");
    console.log("✅ ADVANCED PASSED PAWN DETECTION: Detects pawns on rank 4+, +4 depth per pawn");
    console.log("✅ MULTIPLE PAWN DEFENSE: +6 depth when 2+ dangerous passed pawns detected");
    console.log("✅ AGGRESSIVE WINNING: Creativity 70%, risk 78% when ahead, positional sacrifices");
    console.log("✅ PHILOSOPHY: Beat Level 8 through superior calculation, NOT by removing creativity!");
}
    ...
    wrappedWebSocket.addEventListener("message", function (event) {
        try {
            ...
            if (message.t === "redirect" || message.t === "resync") {
                debugLog("[WS]", "🔄 Server requesting resync/redirect - clearing state");
                calculationLock = false;
                opponentMoveConfirmed = false;
                botJustSentMove = false;
                return;
            ...
            if (message.t === "error" || (message.d && message.d.error)) {
                ...
                debugLog("[WS]", "🔄 Clearing bot state and requesting recalculation");
                
                // Clear stuck state
                calculationLock = false;
                opponentMoveConfirmed = true; // Position is still valid, just need new move
                botJustSentMove = false;
                pendingMove = null;
                
                // Clear move confirmation timer
                if (moveConfirmationTimer) {
                    clearTimeout(moveConfirmationTimer);
                    moveConfirmationTimer = null;
                }
                
                // Recalculate after brief delay
                setTimeout(() => {
    ...
    setTimeout(() => {
        ...
        try {
            ...
            moveConfirmationTimer = setTimeout(() => {
                ...
                if (botJustSentMove && calculationLock === false) {
                    debugLog("[SEND]", "🔄 Move appears rejected - forcing recalculation");
